...
<html>
  ...
  <%
    ...
    <form action="addemp.jsp" method="POST">
    	名称<input type="text" name="pname" id="pname"/><span id="sp1"></span><br/>
    	类型<input type="text" name="note"id="note"/><span id="sp2"></span><br/>
    	价格<input type="text" name="price" id="price"/><span id="sp3"></span><br/>
    	数量<input type="text" name="amount" id="amount"/><span id="sp4"></span><br/>
    	<input type="button" value="添加" id="btn_add"/> <input type="reset" value="重置"/>
    </form>
  </body>
</html>
